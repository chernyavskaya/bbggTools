...
doPUweight = False #should be already in the weight  for flashgg trees
...
data_file = open("datasets/datasets80X_2017.json")
...
prefix = ""
dirSuffix = "20181023_2017_data"
dirPrefix = "/afs/cern.ch/user/n/nchernya/www/HHbbgg/MVA_bregression/2017plots/"
